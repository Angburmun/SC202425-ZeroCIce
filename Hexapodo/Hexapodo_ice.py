...
if 'MovementDirection' not in _M_RoboInterface.__dict__:
    ...
    MovementDirection.TURNLEFT = MovementDirection("TURNLEFT", 4)
    MovementDirection.TURNRIGHT = MovementDirection("TURNRIGHT", 5)
    MovementDirection._enumerators = { 0:MovementDirection.FOWARD, 1:MovementDirection.BACKWARD, 2:MovementDirection.LEFT, 3:MovementDirection.RIGHT, 4:MovementDirection.TURNLEFT, 5:MovementDirection.TURNRIGHT }
...
if 'HexapodControllerPrx' not in _M_RoboInterface.__dict__:
    ...
    HexapodController._op_move = IcePy.Operation('move', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), _M_RoboInterface._t_MovementDirection, False, 0), ((), IcePy._t_string, False, 0)), (), None, ())
